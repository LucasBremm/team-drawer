...
- Peça ao usuário o input para esta sessão.
- Certifique-se de que existe uma pasta .github/sessions/<feature_slug> onde <feature_slug> é um identificador único para esta sessão (pode ser o slug da feature ou story)
- IMPORTANT: Você não deve começar a implementação nessa etapa, somente fazer a documentação e planejamento. O desenvolvimento ocorre em outra etapa.

## Análise

IMPORTANT: Se existir, analise o arquivo issue.md dentro da pasta .github/sessions/<feature_slug>, que ja terá um resumo da issue que será trabalhada.
...
Uma vez que tenha um bom entendimento do que está sendo construído, salve-o no arquivo .github/sessions/<feature_slug>/context.md e peça ao humano para revisar.
...
Dicas:
   ...
   - Use buscas para melhores práticas ou documentação de bibliotecas (se necessário)
...
Uma vez que tenha um bom entendimento do que está sendo construído, salve-o no arquivo .github/sessions/<feature_slug>/architecture.md e peça ao humano para revisar.
...
Se você não tem certeza de como uma biblioteca específica funciona, você pode usar Context7 para buscar informações sobre ela. Então, não tente adivinhar.
