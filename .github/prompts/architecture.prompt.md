...
Dicas:
   ...
   - Pesquise melhores práticas ou documentação de biblioteca (se necessário)
...
Se não tiver certeza de como uma biblioteca específica funciona, você pode usar busque informações sobre ela. Então, não tente adivinhar.
